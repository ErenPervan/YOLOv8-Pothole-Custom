...
# Bu versiyon, standart PyTorch ile dilated conv mantığını kullanarak
...
class DSConv(nn.Module):
    def __init__(self, c1, c2, k=3, s=1):
        ...
        # Standart kare grid yerine daha geniş bir alana bakmasını sağlar.
...
class C2f_SimAM(C2f):
    ...
    def forward(self, x):
        # C2f'in standart forward işlemi + SimAM
